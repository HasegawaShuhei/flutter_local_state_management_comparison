...
class DummyTasksDtoNotifier extends _$DummyTasksDtoNotifier {
  @override
  TasksDto build() => _buildData();

  Future<void> create({
    required String title,
    required String description,
  }) async {
    final tasksDto = state;
    final newTask = TaskDto(
      id: tasksDto.items.length,
      title: title,
