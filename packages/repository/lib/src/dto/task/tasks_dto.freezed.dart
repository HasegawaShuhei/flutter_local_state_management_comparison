...
/// @nodoc
@JsonSerializable()
class _$TasksDtoImpl extends _TasksDto {
  const _$TasksDtoImpl({final List<TaskDto> items = const []})
      : _items = items,
        super._();
...
abstract class _TasksDto extends TasksDto {
  const factory _TasksDto({final List<TaskDto> items}) = _$TasksDtoImpl;
  const _TasksDto._() : super._();
